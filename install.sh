...
cd ~/ && opkg update
echo "Lanjut mase"
wget --no-check-certificate "https://github.com/AchmadPR/Config-Editor-OC/blob/main/luci-app-tinyfm_1.6_all.ipk" -O /cd/tmp/luci-app-tinyfm_1.6_all.ipk
cd/tmp ~/ && opkg install luci-app-tinyfm_1.6_all.ipk --force-depends
