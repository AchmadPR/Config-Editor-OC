...
wget --no-check-certificate "https://github.com/AchmadPR/Config-Editor-OC/blob/main/tinyfm_1.6_all.ipk?raw=true" -O /tmp/fm.ipk && opkg install --force-depends *.ipk
